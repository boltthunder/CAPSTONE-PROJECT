...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background:#2c2c43; ">
            ...
            <li class="nav-item <?php if($_SESSION['title']=="View Organization"){echo "active";}?>">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Barangay Organization</span>
                </a>
                <div id="collapseTwo" class="collapse <?php if($_SESSION['title']=="View Organization"){echo "show";}?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?php if($_SESSION['title']=="View Organization"){echo "active";}?>" href="view-org.php">View Member</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item <?php if($_SESSION['title']=="View Election" || $_SESSION['title']=="View Event"){echo "active";}?>">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>View Event</span>
                </a>
                <div id="collapsePages" class="collapse <?php if($_SESSION['title']=="View Election" || $_SESSION['title']=="View Event"){echo "show";}?>" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manage:</h6>
                        <a class="collapse-item <?php if($_SESSION['title']=="View Election"){echo "active";}?>" href="view-election.php">View election</a>
                        <a class="collapse-item <?php if($_SESSION['title']=="View Event"){echo "active";}?>" href="view-event.php">View Event</a>
            ...
            <li class="nav-item <?php if($_SESSION['title'] == "View Services"){echo "active";}?>" >
                ...
                <div id="PublicNotice" class="collapse <?php if($_SESSION['title'] == "View Services"){echo "show";}?>" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manage:</h6>
                        <a class="collapse-item <?php if($_SESSION['title'] == "View Services"){echo "active";}?>" href="services.php">View Services</a>
                        <!-- <a class="collapse-item" href="register.html">Manage Notice</a> -->
