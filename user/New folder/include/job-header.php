...
<head>
    ...
    <title>HWFMS || Manage Organization</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="brgy_list.php">Barangay List</a>
                        <a class="collapse-item active" href="manage-organization.php">Manage Organization</a>
                    </div>
                </div>
            </li>
