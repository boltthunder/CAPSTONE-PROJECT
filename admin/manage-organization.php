                        ...
                        <div>
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="org_press" id="org_press" class="form-control org-box text-center" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="org_vpress" id="org_vpress" class="form-control org-box text-center" required>
                                            <option value="" selected disabled>---Please Select---</option>
                                            <?php
                                                $member = new memberOrg();
                                                $result = $member->fetchData();
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="" id="secretary" class="form-control text-center org-box">
                                            <option value="" selected disabled>---Please Select---</option>
                                            <?php
                                                $member = new memberOrg();
                                                $result = $member->fetchData();
                                    ...
                                    <div class="form-group">
                                        <label for="treasurer">Tresurer</label>
                                        <select name="" id="treasurer" class="form-control text-center org-box">
                                            <option value="" selected disabled>---Please Select---</option>
                                            <?php
                                                $member = new memberOrg();
                                                $result = $member->fetchData();
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="" id="auditor" class="form-control text-center org-box">
                                            <option value="" selected disabled>---Please Select---</option>
                                            <?php
                                                $member = new memberOrg();
                                                $result = $member->fetchData();
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="" id="pio" class="form-control text-center org-box">
                                            <option value="" selected disabled>---Please Select---</option>
                                            <?php
                                                $member = new memberOrg();
                                                $result = $member->fetchData();
                                    ...
                                    <div class="form-group">
                                        <label for="org-repre">Organization Representative</label>
                                        <select name="" id="org-repre" class="form-control text-center org-box">
                                            <option value="" selected disabled>---Please Select---</option>
                                            <?php
                                                $member = new memberOrg();
                                                $result = $member->fetchData();
